...
var UserDrawing = require('../Map/UserDrawing');
...
var Cesium = function(terria, viewer) {
    GlobeOrMap.call(this, terria, 'cesium-widget-credits');
    ...
    this._userDrawing = new UserDrawing(this, terria);
    ...
    this._userSelectedPointsSubscription = knockout.getObservable( this.terria, 'userSelectedPoints').subscribe(function() {
        this._userDrawing.update();
    }, this);
...
Cesium.prototype.destroy = function() {
    ...
    if (defined(this._userSelectedPointsSubscription)) {
        this.userSelectedPointsSubscription.dispose();
        this.userSelectedPointsSubscription = undefined;
    }
 ...
 * @returns {Array} The features found.
 */
